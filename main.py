...
# Збір URL-адрес продуктів. Закоментуйте, якщо URL-адреси продуктів вже зібрані
# from utils.collect_products_urls import collect_products_urls
# collect_products_urls(categories)

BATCH_SIZE = 100 # Розмір партії для обробки продуктів
...
from utils.importer_legacy import batch_import
